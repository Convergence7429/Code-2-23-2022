...
public class DriveTrain {
    ...
    public void driveTrainByControls() {
        ...
        //     if(driveSpeedCoefficient == 0.3){ // probably just a slow and a normal is fine. Sometimes too fast is uncomfortable
        ...
        if (isDriverControlEnabled) {
            ...
            if(direction){
                mecanumDrive.driveCartesian(driveSpeedCoefficient * ySpeed * ySpeed * yDirectionMaintainer, (driveSpeedCoefficient + 0.1) * -xSpeed * xSpeed * xDirectionMaintainer,
